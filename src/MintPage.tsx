      ...
      <main className="text-center bg-[#dedede]">
        <div className="flex flex-col gap-3 p-4 md:p-12 items-center">
          ...
          <div className="space-y-5 mt-8 font-newtimesroman">
            ...
            Disclaimer:
            <br/><br/>
            B-GOV tokens are a form of equity in Bittrees, Inc. and represent ownership in the organization. As a result, owning B-GOV tokens gives the holder certain rights and privileges, such as voting on important company decisions and receiving a portion of profits through dividends. However, please note that owning B-GOV tokens also involves certain risks, and that the value of the tokens may fluctuate based on a variety of factors, including market conditions and the performance of the company. It is important to carefully consider these risks before minting B-GOV tokens.
            <br/><br/>
            Additionally, B-GOV tokens are subject to different holding levels for different levels of ownership, influence, and rewards in the company. To become a Partner of Bittrees, Inc., a holder must own at least 420 B-GOV tokens, which represents a significant ownership stake in the organization. Junior Partners must hold at least 210 B-GOV tokens, and Associates must hold at least 69 B-GOV tokens. These holding levels are not subject to change and are designed to ensure that ownership and influence in the company are distributed fairly among stakeholders.
            <br/><br/>
            Please note that Bittrees, Inc. does not provide investment advice and is not responsible for any investment decisions made by individuals. It is recommended that potential investors conduct thorough research and seek professional advice before investing in B-GOV tokens.
